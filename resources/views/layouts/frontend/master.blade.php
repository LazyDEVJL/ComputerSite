          ...
          <div class="nav-right">
            <ul class="navbar-right">
              ...
              <!-- USER BASKET -->
                ...
                <li class="dropdown user-acc"> <a href="{{action('FrontendController@register')}}" class="dropdown-toggle" data-toggle="dropdown" role="button" >LOGIN</a>
                  <ul class="dropdown-menu">
                    ...
                    <li>
                      ...
                      <p class="font-italic text-center" style='color:red'>{{ $errors->first('user') }}</p>
                    </li>
                    <li>
                      <label for="pass">Password</label>
                      <input id='pass' class='form-control' name='password' type="text">
                      <p class="font-italic text-center" style='color:red'>{{ $errors->first('password') }}</p>
                    </li>
                    <li>
      ...
      <div class="tp-banner">
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="{{asset('frontend/images/slide-bg-1.jpg')}}"  alt="slider"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
            <!-- LAYER NR. 1 -->
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="{{asset('frontend/images/slide-bg-2.jpg')}}"  alt="slider"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
            <!-- LAYER NR. 1 -->
            <div class="tp-caption font-playfair sfb tp-resizeme" 
