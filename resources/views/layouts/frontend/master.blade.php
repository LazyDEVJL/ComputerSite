	...
	<div id="wrap">
						...
						<div class="nav-right">
							<ul class="navbar-right">
								...
								<li class="dropdown user-acc">
									<a href="{{action('FrontendController@register')}}" class="dropdown-toggle" data-toggle="dropdown" role="button">
										<i class="icon-user"></i>
									</a>
									<ul class="dropdown-menu">
										<li>
											<h6>Hello, @if(session()->has('name')) {{ Session::get('name')}} @endif
											</h6>
										</li>
										<li>
										...
										<li>
											<a href="{{action('FrontendController@logout')}}">LOG OUT</a>
										</li>
									</ul>
								</li>
									...
									<ul class="dropdown-menu">
										...
										<li>
											<div class="media-left">
												<div class="cart-img">
													<a href="{{$cart['product']->slug}}">
														<img class="media-object img-responsive" src="{{asset($cart['product']->image)}}" alt="{{$cart['product']->name}}">
													</a>
												</div>
											</div>
											<div class="media-body">
												...
												<span class="price">
													@if($cart['product']->discount != 0 || $cart['product']->discount != null) {{$cart['product']->discounted_price}} USD @else
													{{$cart['product']->price}} USD @endif
												</span>
												<span class="qty">QTY: {{$cart['qty']
													< 10 ? '0' : ''}}{{$cart[ 'qty']}}</span>
											</div>
										</li>
										@endforeach
								...
								<li class="dropdown user-acc 
									...
									">
									<a href="{{action('FrontendController@register')}}" class="dropdown-toggle" data-toggle="dropdown" role="button" {{ session()->has('login-error') ? 'area-expanded=\'true\'' : '' }} {{ $errors->has('user') ? 'area-expanded=\'true\'' : '' }}
										{{ $errors->has('password') ? 'area-expanded=\'true\'' : '' }} >LOGIN
									</a>
									<ul class="dropdown-menu" style="padding:20px;">
										<form action="{{action('FrontendController@login')}}" method='post'>
											...
											<li>
												...
												">
												<p class="font-italic text-center" style='color:red; font-size:12px;'>{{ $errors->first('user') }}</p>
											</li>
											<li>
												...
												">
												<p class="font-italic text-center" style='color:red; font-size:12px'>{{ $errors->first('password') }}</p>
											</li>
											<li>
											...
											<li style="margin-top:10px !important;">
												<p class="font-italic" style='color:red; font-size:12px; margin:0;'>{{ session()->get('login-error') }}</p>
											</li>
											@endif
										</form>
									</ul>
								...
								<li class="dropdown user-basket">
									...
									<ul class="dropdown-menu">
										...
										<li>
											...
											<div class="media-body">
												<h6 class="media-heading">{{$cart['product']->name}}</h6>
												<span class="price">{{$cart['product']->price}} USD</span>
												<span class="qty">QTY: {{$cart['qty']
													< 10 ? '0' : ''}}{{$cart[ 'qty']}}</span>
											</div>
										</li>
			...
			<section class="small-about padding-top-150 padding-bottom-150">
				<div class="container">
					...
					<div class="heading text-center">
						...
						<p>Phasellus lacinia fermentum bibendum. Interdum et malesuada fames ac ante ipsumien lacus, eu posuere odio luctus non.
							Nulla lacinia, eros vel fermentum consectetur, risus purus tempc, et iaculis odio dolor in ex. </p>
					</div>
		...
		<footer style="padding-top:0;">
			<div class="container">
				...
				<!-- Rights -->
				<div class="rights">
					<p style="font-size: 14px;">© 2018 {{config('app.name')}} built by Luu Tuan Minh and Tran Nhat Duy with <i class="fa fa-coffee"></i> and <i class="fa fa-heart"></i>. </p>
					<div class="scroll">
