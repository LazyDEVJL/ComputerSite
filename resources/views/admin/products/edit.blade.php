...
@section('content')
   ...
   <h3 class="text-center mt-5">Sửa danh mục</h3>
   <hr>
   <p class="text-center">
      <a href="<?=action('CategoryController@index')?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Trở lại
   ...
   <div align="center" class="table-responsive">
      <form action="<?=action('CategoryController@editSave')?>" method="post">
         ...
         <table class="table w-50">
            ...
            <tr>
               <th>Position</th>
               <td><input type="number" class="form-control" name="txt_position" value="<?=$editCategory->position?>">
               </td>
            </tr>
            <tr>
               <th>Show/Hide</th>
               <td>
                  Show: <input type="radio" value="1"
                               name="rd_active" <?=$editCategory->active == 1 ? 'checked' : '' ?>>
                  Hide: <input type="radio" value="0"
                               name="rd_active" <?=$editCategory->active == 0 ? 'checked' : '' ?>>
               </td>
            </tr>
            <tr>
               <th>Slug</th>
