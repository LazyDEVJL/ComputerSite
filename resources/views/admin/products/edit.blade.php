      ...
      <section class="content">
         ...
         <div class="card w-75">
            ...
            <form action="{{ action('ProductController@editSave') }}" method="post" class="form-horizontal"
               ...
               <input type="hidden" name="currentImage" value="{{$currentProduct->image}}">
               <div class="card-body">
                  <div class="form-row">
                     ...
                     <div class="form-group col-lg-2">
                        ...
                        <div class="input-group">
                           <input type="number" name="txt_discount" id="discount"
                                  ...
                                  value="{{old('txt_discount', $currentProduct->discount)}}">
                           <div class="input-group-append">
                              <div class="input-group-text">
                                 <span>%</span>
                              </div>
                  ...
                  <div class="row">
                     <div class="col-lg-2">
                        <label for="current-product-image">Product's current thumbnail</label>
