      ...
      <section class="content">
        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade" id="cpu" role="tabpanel" aria-labelledby="cpu-tab">
                <div class="card w-50">
                    <div class="card-header">
                        <h3 class='card-title'>Create new Cpu</h3>
                    </div>
                    <div class="card-body">
                ...
                <div class="card w-50">
                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <p class="font-italic font-weight-bold text-center" style='color:red'>{{ $errors->first('sl_drive_type') }}</p>
                            <div class="row">
                                <div class="col-lg-5"></div>
                                <div class="text-center col-lg-2">
                                    <input type="submit" value='Submit' class='btn btn-success mr-5'>
                ...
                <div class="card w-50">
                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            ...
                            <p class="font-italic font-weight-bold text-center" style='color:red'>{{ $errors->first('sl_mb_manu') }}</p>
                            <div class="row">
                                <div class="col-lg-5"></div>
                                <div class="text-center col-lg-2">
                                    <input type="submit" value='Submit' class='btn btn-success mr-5'>
                ...
                <div class="card w-50">
                    ...
                    <div class="card-body">
                        <form action="{{ action('PropertiesController@saveMt_time') }}" method='post'>
                            ...
                            <p class="font-italic font-weight-bold text-center" style='color:red'>{{ $errors->first('txt_mt_time') }}</p>
                            <div class="row">
                                <div class="col-lg-5"></div>
                                <div class="text-center col-lg-2">
                                    <input type="submit" value='Submit' class='btn btn-success mr-5'>
            ...
            <div class="tab-pane fade" id="psuType" role="tabpanel" aria-labelledby="cpu-tab">
                <div class="card w-50">
                    <div class="card-header">
                        <h3 class='card-title'>Create new Psu Type</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ action('PropertiesController@savePsu_type') }}" method='post'>
                            @csrf
                            <div class="form-group row">
                                <label for="DriverText" class='col-lg-2'>Psu Type</label>
                                <div class="col-lg-10">
                                    <input id='DriverText' type="text" class='form-control' name='txt_psu_type'>
                                </div>
                            </div>
                ...
                <div class="card w-50">
                    ...
                    <div class="card-body">
                        <form action="{{ action('PropertiesController@saveRam_ca') }}" method='post'>
                            ...
                            <p class="font-italic font-weight-bold text-center" style='color:red'>{{ $errors->first('txt_ram_ca') }}</p>
                            <div class="row">
                                <div class="col-lg-5"></div>
                                <div class="text-center col-lg-2">
                                    <input type="submit" value='Submit' class='btn btn-success mr-5'>
                ...
                <div class="card w-50">
                    ...
                    <div class="card-body">
                        <form action="{{ action('PropertiesController@saveRam_sp') }}" method='post'>
                            ...
                            <p class="font-italic font-weight-bold text-center" style='color:red'>{{ $errors->first('txt_ram_sp') }}</p>
                            <div class="row">
                                <div class="col-lg-5"></div>
                                <div class="text-center col-lg-2">
                                    <input type="submit" value='Submit' class='btn btn-success mr-5'>
            ...
            <div class="tab-pane fade" id="ssdFactor" role="tabpanel" aria-labelledby="cpu-tab">
                <div class="card w-50">
                    <div class="card-header">
                        <h3 class='card-title'>Create new SSD Factor</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ action('PropertiesController@saveSSD_ff') }}" method='post'>
                            @csrf
                            <div class="form-group row">
                                <label for="DriverText" class='col-lg-2'>SSD Factor</label>
                                <div class="col-lg-10">
                                    <input id='DriverText' type="text" class='form-control' name='txt_ssd_ff'>
                                </div>
                            </div>
                            <p class="font-italic font-weight-bold text-center" style='color:red'>{{ $errors->first('txt_ssd_ff') }}</p>
                            <div class="row">
                                <div class="col-lg-5"></div>
                                <div class="text-center col-lg-2">
                                    <input type="submit" value='Submit' class='btn btn-success mr-5'>
                ...
                <div class="card w-50">
                    ...
                    <div class="card-body">
                        <form action="{{ action('PropertiesController@saveVGA_mem') }}" method='post'>
                            ...
                            <p class="font-italic font-weight-bold text-center" style='color:red'>{{ $errors->first('txt_vga_mem') }}</p>
                            <div class="row">
                                <div class="col-lg-5"></div>
                                <div class="text-center col-lg-2">
                                    <input type="submit" value='Submit' class='btn btn-success mr-5'>
