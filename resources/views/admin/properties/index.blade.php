   ...
   <div class="content-wrapper">
      ...
      <section class="content">
         ...
         <div class="tab-content" id="pills-tabContent">
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllCase as $case)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editCase',['id'=>$case->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delCase',['id'=>$case->id])}}"
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllCpu as $cpu)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editCpu',['id'=>$cpu->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delCpu',['id'=>$cpu->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllHdd as $hdd)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editHdd',['id'=>$hdd->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delHdd',['id'=>$hdd->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editMb',['id'=>$mb->id])}}" class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delMb',['id'=>$mb->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllMb_size as $mb_size)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editMb_size',['id'=>$mb_size->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delMb_size',['id'=>$mb_size->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllMnt_RR as $mt_rr)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editMt_RR',['id'=>$mt_rr->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delMt_RR',['id'=>$mt_rr->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllMt_res as $mt_res)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editMt_Res',['id'=>$mt_res->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delMt_Res',['id'=>$mt_res->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllMt_response as $mt_time)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editMt_time',['id'=>$mt_time->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delMt_time',['id'=>$mt_time->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllMt_size as $mt_size)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editMt_size',['id'=>$mt_size->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delMt_size',['id'=>$mt_size->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
            ...
            <div class="tab-pane fade" id="psuEE" role="tabpanel" aria-labelledby="mt_rr-tab">
               @include('layouts.properties.master2')
               PSU Energy Efficiency
               @include('layouts.properties.master3')
               <input type="text" name="q-psu-ee" placeholder="Search by Type" class="form-control">
               @include('layouts.properties.master4')
               <table class="table table-hover table-valign-middle text-center">
                  <tbody>
                  <tr>
                     <th>ID</th>
                     <th>PSU Energy Efficiency</th>
                     <th colspan="2">Action</th>
                  </tr>
                  @foreach($AllPsuEE as $psu_ee)
                     <tr>
                        <td>{{$psu_ee->id}}</td>
                        <td>{{$psu_ee->psu_ee}}</td>
                        <td>
                           <a href="{{action('PropertiesController@editPsu_EE',['id'=>$psu_ee->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delPsu_EE',['id'=>$psu_ee->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllPsuPw as $psu_pw)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editPsu_pw',['id'=>$psu_pw->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delPsu_pw',['id'=>$psu_pw->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllCapacity as $ram_ca)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editRam_ca',['id'=>$ram_ca->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delRam_ca',['id'=>$ram_ca->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllSpeed as $speed)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editRam_sp',['id'=>$speed->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delRam_sp',['id'=>$speed->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllFormFactor as $factor)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editSSD_ff',['id'=>$factor->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delSSD_ff',['id'=>$factor->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllInterface as $interface)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editSSD_interface',['id'=>$interface->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delSSD_interface',['id'=>$interface->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllGpu as $gpu)
                     <tr>
                        ...
                        <td>{{$gpu->vga_gpu}}</td>
                        <td>
                           <a href="{{action('PropertiesController@editVGA_gpu',['id'=>$gpu->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delVGA_gpu',['id'=>$gpu->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
               ...
               <table class="table table-hover table-valign-middle text-center">
                  ...
                  @foreach($AllMem as $mem)
                     <tr>
                        ...
                        <td>
                           <a href="{{action('PropertiesController@editVGA_mem',['id'=>$mem->id])}}"
                              class="btn btn-default">
                              <i class="fa fa-edit"></i> &nbsp;&nbsp;Edit</a>
                           <a href="{{action('PropertiesController@delVGA_mem',['id'=>$mem->id])}}"
                              onclick="return confirm('Are you sure?');" class="btn btn-danger">
                              <i class="fa fa-trash-alt"></i> &nbsp;&nbsp;Delete</a>
                        </td>
                     </tr>
