         ...
         <div class="tp-banner">
            <ul>
               ...
               <li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
                  <!-- MAIN IMAGE -->
                  <img src="{{asset('frontend/images/slide-bg-1.jpg')}}" alt="slider" data-bgposition="center center"
                  ...
                  <div class="tp-caption sfl font-extra-bold tp-resizeme"
                     ...
                     <small class="font-regular">$</small>
                     299
                  </div>
                  <!-- LAYER NR. 2 -->
               ...
               <li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
                  <!-- MAIN IMAGE -->
                  <img src="{{asset('frontend/images/slide-bg-2.jpg')}}" alt="slider" data-bgposition="center center"
                       data-bgfit="cover" data-bgrepeat="no-repeat">
                  <!-- LAYERS -->
                  <!-- LAYER NR. 1 -->
                  <div class="tp-caption font-playfair sfb tp-resizeme"
         ...
         <!-- Item -->
            <div class="item">
               ...
               <div class="overlay">
                  ...
                  <div class="position-center-center"><a href="{{$product->image}}" data-lighter><i
