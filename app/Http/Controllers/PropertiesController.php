...
class PropertiesController extends Controller
{
    public function index(){
        ...
        $psu_type_key=Input::get('q-psu-type');
        $psu_type=getProperties($psu_type_key,'tbl_psu_ees','psu_ee');
    ...
    public function saveMb(Request $rq){
        ...
        if ($validator->fails()) {
            ...
            $mb_chipsets->chipset_manufactur=$mb_manufacture;
    ...
    public function editSaveMb(Request $rq){
        ...
        if ($validator->fails()) {
            ...
            $mb_chipsets=MbChipset::find($id); 
            $mb_chipsets->mb_chipset=$chipset;
            $mb_chipsets->chipset_manufactur=$mbManu;
            $check=$mb_chipsets->save();
            if ($check) {
                Session::flash('success', 'Successfully Editied');
                return redirect('/admin/properties');
    ...
    public function saveMt_RR(Request $rq){
        ...
        if ($validator->fails()) {
            ...
            $mtRR=$rq->txt_mt_rr;
            $moniterRR=new MntRefreshRate();
            $moniterRR->mnt_refresh_rate=$mtRR;
            $check=$moniterRR->save();
            if ($check) {
    ...
    public function editSaveMt_RR(Request $rq){
        ...
        if ($validator->fails()) {
            ...
            $id=$rq->mt_rr_id;
            $mtRR=$rq->txt_mt_rr;
            $moniterRR=MntRefreshRate::find($id);
            $moniterRR->mnt_refresh_rate=$mtRR;
            $check=$moniterRR->save();
            if ($check) {
                Session::flash('success', 'Successfully Edited');
    ...
    public function editSaveMt_Res(Request $rq){
        ...
        if ($validator->fails()) {
            ...
            $id=$rq->mt_res_id;
            $mtRes=$rq->txt_mt_res;
            $moniterRes=MntResolution::find($id);
            $moniterRes->mnt_resolution=$mtRes;
            $check=$moniterRes->save();
            if ($check) {
                Session::flash('success', 'Successfully Edited');
                return redirect('/admin/properties');
            } else {
    ...
    public function editSaveMt_time(Request $rq){
        ...
        if ($validator->fails()) {
            ...
            $id=$rq->mt_time_id;
            $mtTime=$rq->txt_mt_time;
            $moniterTime=MntResponseTime::find($id);
            $moniterTime->mnt_response_time=$mtTime;
            $check=$moniterTime->save();
            if ($check) {
                Session::flash('success', 'Successfully Edited');
                return redirect('/admin/properties');
            } else {
    ...
    public function editSaveMt_size(Request $rq){
        ...
        if ($validator->fails()) {
            ...
            $id=$rq->mt_size_id;
            $mtSize=$rq->txt_mt_size;
            $moniterSize=MntScreenSize::find($id);
            $moniterSize->mnt_screen_size=$mtSize;
            $check=$moniterSize->save();
            if ($check) {
                Session::flash('success', 'Successfully Edited');
                return redirect('/admin/properties');
            } else {
    ...
    public function delMt_size($id){
        $moniterTime=MntScreenSize::find($id);
        $check=$moniterTime->delete();
        if ($check) {
            Session::flash('success', 'Successfully deleted');
            return redirect('/admin/properties');
    ...
    public function savePsu_type(Request $rq){
        $validator=PropertiesRules($rq,'txt_psu_type','Psu type');

        if ($validator->fails()) {
            return redirect()->back()->withInput()->withErrors($validator);
        }else{
            $psuType=$rq->txt_psu_type;
            $psuEE=new PSUEE();
    ...
    public function editPsu_type($id){
        $psuType=PSUEE::find($id);
        return view('admin/properties/editPsu_type',['CurrentPsu_type'=>$psuType]);
    }

    public function editSavePsu_type(Request $rq){
        $validator=PropertiesRules($rq,'txt_psu_type','Psu type');
    ...
    public function delPsu_type($id){
        $psuType=PSUEE::find($id);
