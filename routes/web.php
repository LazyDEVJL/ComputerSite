...
// Danh sach cac Properties 
  ...
  // Psu Type
  Route::post('/admin/properties/psu-type/create/','PropertiesController@savePsu_type');
  Route::get('/admin/properties/psu-type/edit/{id}','PropertiesController@editPsu_type');
  Route::post('/admin/properties/psu-type/save/','PropertiesController@editSavePsu_type');
  Route::get('/admin/properties/psu-type/delete/{id}','PropertiesController@delPsu_type');
  // Psu power
